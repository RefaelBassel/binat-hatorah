...
export const WRITING_LEVELS: WritingLevel[] = [
    ...
    exercises: [
      {
        ...
        intro: "סווגי כל משפט: איזה מרכיב של הטיעון הוא?",
        sentences: [
      ...
      },
      {
        ...
        intro:
          "שימי לב: הפעם המשפטים לא מסודרים לפי הסדר הקלאסי! סווגי כל אחד.",
        sentences: [
      ...
      },
      {
        ...
        intro:
          "הטמאים פונים אל משה. סווגי את מרכיבי הטיעון שלהם (שימי לב: אחד המשפטים הוא הנחה שהם לא אמרו בקול!):",
        sentences: [
  ...
  },
  {
    ...
    emoji: "🔍",
    description:
      "מתחת לכל טיעון מסתתרות הנחות שלא נאמרות בקול. מי שיודעת לחשוף אותן — מבינה את הטיעון באמת.",
    exercises: [
      {
        kind: "mc",
        key: "w2-homework",
      ...
      },
      {
        ...
        prompt:
          "בדילמת הרובוטיקה, ההנהלה טענה: ״אם נחריג אתכם, ייגרם תקדים מסוכן והסדר ייפגע.״ נסי לחשוף: איזו הנחת יסוד סמויה עומדת מאחורי הטענה הזו? (רמז: מה ההנהלה מניחה שיקרה אם עושים חריגה אחת?)",
        fields: [
          {
            key: "assumption",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        kind: "free",
        key: "w3-hanhala",
        title: "שופטות את ההנהלה",
        flavor: "🏫 מהדילמה שלנו",
        why: "הערכה הוגנת רואה גם חוזק וגם חולשה",
        prompt:
          "טיעון ההנהלה: ״התקנון תקף לכולם. אם נחריג אתכם ייגרם תקדים מסוכן, ולכן איננו מחריגים.״ — כתבי: מה החזק בטיעון הזה, ומה החלש בו? (התייחסי למרכיבים: הנחות, נימוק, מסקנה)",
        fields: [
    ...
    exercises: [
      {
        ...
        prompt:
          "בחרי נושא קליל שחשוב לך באמת (למשל: למה ראוי להאריך את ההפסקה הגדולה / למה כדאי לישון עם גרביים) ובני טיעון שלם:",
        fields: [
      ...
      },
      {
        ...
        prompt:
          "משה בחר לעצור ולשאול את ה׳ במקום להשיב מיד לטמאים. בני טיעון בעד או נגד ההחלטה הזו כדרך מנהיגות — עם נימוק אחד לפחות מהפסוקים עצמם:",
        fields: [
          { key: "claim", label: "📌 הטענה שלי" },
          { key: "reason", label: "🧱 נימוק מהפסוקים (צטטי או תארי)" },
