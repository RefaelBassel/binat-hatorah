  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        prompt:
          "בדילמת הרובוטיקה, ההנהלה טענה: ״אם נחריג אתכם, ייגרם תקדים מסוכן והסדר ייפגע.״ נסו לחשוף: איזו הנחת יסוד סמויה עומדת מאחורי הטענה הזו? זכרו — הנחת יסוד מנוסחת בצורה כללית, בלשון רבים, עם המילים תמיד / אף פעם / כל.",
        fields: [
          {
            key: "assumption",
            label: "הנחת היסוד הסמויה של ההנהלה (בצורה כללית: תמיד / אף פעם / כל)",
            placeholder: "ההנהלה מניחה שכל חריגה מכלל תמיד...",
          },
        ],
      },
    ],
    ...
    exercises: [
      {
        ...
        fields: [
          ...
          { key: "assumption", label: "🔍 הנחת היסוד — הפעם אומרים אותה בקול (בצורה כללית: תמיד / אף פעם / כל)" },
