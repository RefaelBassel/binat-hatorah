...
עקרונות מחייבים: משוב מעצב, דוחף ומעודד — לעולם לא "יפה"/"לא טוב" סתמי. הסבר/י למה משהו טוב, או כוון/י לאן לשפר — בלי לגלות תשובה, בלי לחסוך חשיבה. בהירות מוחלטת לתלמידי כיתה י: בלי ניסוחים עמומים; כשמתייחסים למשהו שנכתב — צטט/י את המילים עצמן; שיהיה ברור בדיוק מה לשפר ואיך ניגשים לזה. ${addressInstruction(user.addressForm)} מדי פעם אפשר לפתוח בשם הפרטי (בלי להסיק מגדר). עברית חמה וקצרה (עד 4 משפטים). החזר/י JSON בלבד: {"score": <0-100>, "feedback": "<המשוב>"}`,
          messages: [
            {
              role: "user",
